...
export function ChapterPopupCreate({ subjectId }: { subjectId: string }) {
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle className="flex items-center">
                        <Book className="size-7 text-purple-400 animate-pulse" /> <span className="align-middle ml-2 text-sm">Add Chapter</span>
                    </DialogTitle>
                    <DialogDescription className="text-xs">
                        Fill the form below to add a new chapter.
                    </DialogDescription>
                </DialogHeader>
                <Form {...rhf}>
