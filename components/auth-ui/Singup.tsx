...
type SignUpDataSchema = z.infer<typeof signUpSchema>;
...
export function SignUpForm({
  ...
  const rhf = useForm<SignUpDataSchema>({
  ...
  const submitForm = async (data: SignUpDataSchema) => {
    ...
    ToastSuccess(res.data?.message || "Signup successful!");
    redirect("/");
  };
  return (
